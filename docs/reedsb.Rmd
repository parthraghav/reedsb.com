...
b. Elections $\leftarrow$ $\{$users_who_have_voted, nominations$\}$
...
2. Change the $\textit{secampaign}$ entry in the $.CONFIG$ file to reflect the current funding poll ID. Recall that it must follow the form:
